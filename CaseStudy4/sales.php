...
<link rel="stylesheet" href = "CSS/style.css">
    ...
    <?php 
        ...
        //$data_col = array("saleid", "salegroupid", "productid", "quantity", "amount");
        $product_table = array(array());
        ...
        for($i=0; $i < $num_results; $i++){
            ...
            $product_table[$abbre_name] = $row;
        }

        echo $product_table['CALsgl']['price'];


        // $query = "select productid, sum(amount) from sales group by productid;";
        // $total_sales_result = $db->query($query);



        // $sales_table = array(array());
        // echo $total_sales_result;
        // $num_results = $total_sales_result->num_rows;
        
        // for($i=0; $i < $total_sales_result; $i++){
        //     $row = $result ->fetch_assoc();
        //     $abbre_name = $row['productid'];
        //     $product_table[$abbre_name] = $row;
        // }

        // $product_result->free();
        // $total_sales_result->free();
        // $db->close();
...
<div id="wrapper">
    <body onload = "onLoad()">      
        ...
        <div id="main_content">
        <div >
                <h1 id="title" > Select sales mode to see: </h1>
        </div>
